...
<div class="bg-primary pt-12 pb-24 px-6 rounded-b-[40px] relative overflow-hidden">
    ...
    <div class="relative z-10">
        <h1 class="text-2xl font-bold text-white mb-2">Visi & Misi</h1>
        <p class="text-white/80 text-sm">Arah dan tujuan perjuangan kami.</p>
    </div>
</div>
...
<div class="px-6 -mt-16 relative z-20 space-y-6 pb-24">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
        <div class="flex items-center gap-3 mb-4">
            ...
            <h2 class="font-bold text-gray-900 text-lg">Visi</h2>
        </div>
        <div class="prose prose-sm max-w-none text-gray-600">
            {!! $visionMission->visi ?? '<p class="text-gray-500 italic">Visi belum diatur.</p>' !!}
        </div>
    </div>
    ...
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4">
        <div class="flex items-center gap-3 mb-4">
            ...
            <h2 class="font-bold text-gray-900 text-lg">Misi</h2>
        </div>
        
        <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
            <div class="prose prose-sm max-w-none text-gray-600">
                {!! $visionMission->misi ?? '<p class="text-gray-500 italic">Misi belum diatur.</p>' !!}
            </div>
        </div>
    </div>
</div>
