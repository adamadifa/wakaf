...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-6xl mx-auto px-5">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-900">Riwayat Zakat</h1>
                ...
                <table class="w-full text-left border-collapse">
                    <thead class="bg-gray-50 border-b border-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Jenis Zakat</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-semibold text-gray-900">{{ $transaction->zakatType->name }}</div>
                                <div class="text-xs text-gray-500">{{ $transaction->invoice_number }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="{{ route('donor.receipt', $transaction->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center justify-center">
                                    <i class="ti ti-wallet-off text-4xl mb-3 text-gray-300"></i>
                                    <p class="font-medium">Belum ada riwayat zakat.</p>
                                    <a href="{{ route('zakat.index') }}" class="mt-3 btn btn-primary btn-sm">Tunaikan Zakat</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
