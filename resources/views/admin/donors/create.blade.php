...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8 pl-1">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Tambah Donatur Baru</h1>
        <p class="text-gray-500 mt-1">Tambahkan data donatur baru ke sistem.</p>
    </div>
    ...
    <form action="{{ route('admin.donors.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="form-input @error('name') border-red-500 @enderror" placeholder="Nama Lengkap Donatur">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="form-input @error('email') border-red-500 @enderror" placeholder="email@example.com">
            ...
            <div class="pt-4 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dark transition-all shadow-lg shadow-primary/30">Simpan Donatur</button>
            </div>
        </div>
    </form>
</div>
