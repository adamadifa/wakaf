...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 pl-1">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Edit Program Infaq</h1>
        <p class="text-gray-500 mt-1">Perbarui informasi program infaq.</p>
    </div>

    <form action="{{ route('admin.infaq-categories.update', $infaqCategory) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $infaqCategory->name) }}" required 
            ...
            <div>
                ...
                <textarea name="description" id="description-editor">{{ old('description', $infaqCategory->description) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="icon" value="{{ old('icon', $infaqCategory->icon) }}" 
                    ...
                    <div class="space-y-3">
                        @if($infaqCategory->image)
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-100">
                                <img src="{{ Str::startsWith($infaqCategory->image, 'http') ? $infaqCategory->image : asset($infaqCategory->image) }}" class="h-12 w-16 object-cover rounded-lg" alt="Current Image">
