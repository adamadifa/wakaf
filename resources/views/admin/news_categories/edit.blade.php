...
<div class="max-w-xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] overflow-hidden">
        ...
        <form action="{{ route('admin.news-categories.update', $newsCategory->id) }}" method="POST" class="mt-6 p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="name" value="{{ old('name', $newsCategory->name) }}" required 
