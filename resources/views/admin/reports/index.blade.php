...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.reports.export', request()->all()) }}" class="px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 no-print">
        <form action="{{ $forceType == 'zakat' ? route('admin.reports.zakat') : ($forceType == 'donation' ? route('admin.reports.donation') : route('admin.reports.index')) }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 items-end">
            <div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $transaction->type == 'Zakat' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                                    {{ $transaction->type }}
                                </span>
