...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8 pl-1">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Tambah Metode Pembayaran</h1>
        <p class="text-gray-500 mt-1">Tambahkan rekening baru untuk penerimaan donasi.</p>
    </div>
    ...
    <form action="{{ route('admin.payment-methods.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 shadow-sm space-y-5">
            ...
            <div>
                ...
                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-input @error('bank_name') border-red-500 @enderror" placeholder="Contoh: Bank Syariah Indonesia">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="account_number" value="{{ old('account_number') }}" class="form-input @error('account_number') border-red-500 @enderror" placeholder="Contoh: 1234567890">
                ...
                <div>
                    ...
                    <input type="text" name="account_name" value="{{ old('account_name') }}" class="form-input @error('account_name') border-red-500 @enderror" placeholder="Contoh: Yayasan Wakaf">
            ...
            <div>
                 ...
                 <div class="relative group">
                    ...
                    <div class="w-full h-32 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center gap-2 text-gray-400 hover:border-primary hover:text-primary transition-all cursor-pointer bg-gray-50/50" onclick="document.getElementById('logo_input').click()">
                        <div id="preview_container" class="hidden w-full h-full p-2 flex items-center justify-center">
                            <img id="preview_img" src="" class="max-h-full max-w-full object-contain">
                        </div>
            ...
            <div>
                ...
                <textarea name="instructions" rows="3" class="form-input @error('instructions') border-red-500 @enderror" placeholder="Catatan tambahan untuk donatur...">{{ old('instructions') }}</textarea>
            ...
            <div class="flex items-center gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="w-5 h-5 text-primary rounded border-gray-300 focus:ring-primary">
            ...
            <div class="pt-4 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dark transition-all shadow-lg shadow-primary/30">Simpan Data</button>
            </div>
        </div>
    </form>
</div>
