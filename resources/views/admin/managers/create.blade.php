...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] overflow-hidden">
        <div class="p-8 border-b border-gray-50">
            <h2 class="text-xl font-bold text-gray-800">Tambah Pengurus Baru</h2>
        </div>
        
        <form action="{{ route('admin.managers.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            
            <div class="mb-6">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Nama Lengkap</label>
                <input type="text" name="name" value="{{ old('name') }}" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('name') border-red-500 @enderror" placeholder="Nama lengkap pengurus...">
                @error('name') <p class="mt-1 text-sm text-red-500">{{ $message }}</p> @enderror
            </div>

            <div class="mb-6">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Jabatan</label>
                <input type="text" name="position" value="{{ old('position') }}" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('position') border-red-500 @enderror" placeholder="Contoh: Ketua Yayasan">
            ...
            <div class="mb-6">
                ...
                <textarea name="bio" rows="3" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('bio') border-red-500 @enderror" placeholder="Deskripsi singkat tentang pengurus...">{{ old('bio') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="url" name="facebook_link" value="{{ old('facebook_link') }}" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('facebook_link') border-red-500 @enderror" placeholder="https://facebook.com/username">
                ...
                <div>
                    ...
                    <input type="url" name="instagram_link" value="{{ old('instagram_link') }}" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('instagram_link') border-red-500 @enderror" placeholder="https://instagram.com/username">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="number" name="order" value="{{ old('order', 0) }}" class="form-input w-full px-4 py-3 rounded-xl border border-gray-200 outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all @error('order') border-red-500 @enderror">
