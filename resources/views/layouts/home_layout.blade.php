            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white items-center">
                    ...
                    <li class="relative group">
                        <button class="nav-link block py-2 px-3 flex items-center gap-1 group-hover:text-primary {{ request()->routeIs('wakaf.*') || request()->routeIs('zakat.*') || request()->routeIs('infaq.*') || request()->routeIs('programs.*') ? 'text-secondary' : '' }}">
                            Layanan
                            <svg class="w-2.5 h-2.5 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                            </svg>
                        </button>
                        <div class="absolute z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-48 group-hover:block transition-all duration-300 transform origin-top-left">
