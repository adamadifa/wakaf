...
<section class="relative py-24 bg-primary/10 overflow-hidden">
    ...
    <div class="container relative z-10 text-center">
        ...
        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 font-serif">Visi & Misi Wakaf</h1>
        <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Komitmen kami dalam mengelola wakaf secara amanah dan produktif untuk kesejahteraan umat.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="max-w-4xl mx-auto text-center">
            <div class="mb-12">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2">Visi Wakaf</h2>
                ...
                <div class="relative z-10">
                    <div class="prose prose-xl mx-auto text-gray-800 font-medium leading-relaxed font-serif">
                        @if($visionMission && $visionMission->visi)
                             {!! $visionMission->visi !!}
                        @else
                            <p class="text-gray-400 italic">"Visi wakaf belum diatur."</p>
                        @endif
                    </div>
                </div>
...
<section class="py-16 bg-gray-50 relative overflow-hidden">
    ...
    <div class="container relative z-10">
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Misi Wakaf</h2>
            <p class="text-gray-500 mt-2">Langkah nyata pengelolaan wakaf.</p>
        </div>
                ...
                <div class="prose prose-lg max-w-none text-gray-600">
                     @if($visionMission && $visionMission->misi)
                        <!-- If the user content is a list, styling is handled by prose. If plain text, we wrap it. -->
                         {!! $visionMission->misi !!}
                    @else
                        <p class="text-gray-500 italic text-center">Misi wakaf belum diatur.</p>
                    @endif
                </div>
            </div>
        </div>
...
<section class="py-20">
    <div class="container">
        <div class="bg-primary rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h2 class="text-3xl md:text-4xl font-bold mb-6 font-serif">Bergabung Dalam Gerakan Wakaf</h2>
                <p class="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Mari berkontribusi untuk kebaikan umat melalui wakaf.</p>
