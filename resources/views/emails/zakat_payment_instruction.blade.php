...
<head>
    ...
    <title>Instruksi Pembayaran Zakat</title>
</head>
<body style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 0; background-color: #f8f9fa;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            <h2 style="color: #2596be; margin: 0; font-size: 24px;">Instruksi Pembayaran Zakat</h2>
        ...
        <div style="margin-bottom: 30px;">
            ...
            <p style="margin: 0 0 20px;">
                Terima kasih telah menunaikan zakat melalui WakafApp. Berikut adalah detail pembayaran zakat Anda:
            </p>
            ...
            <div style="background-color: #f8f9fa; border: 1px solid #e9ecef; border-radius: 8px; padding: 20px; margin-bottom: 25px;">
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 15px;">
                    ...
                    <tr>
                        <td style="padding: 8px 0; color: #6c757d; font-size: 14px;">Jenis Zakat</td>
                        <td align="right" style="padding: 8px 0; font-weight: 600;">{{ $transaction->zakatType->name }}</td>
                    </tr>
                </table>
                <div style="border-top: 1px dashed #dee2e6; margin: 10px 0;"></div>
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding: 8px 0; color: #6c757d; font-size: 14px;">Nominal Zakat</td>
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <a href="{{ route('zakat.success', $transaction->invoice_number) }}" style="display: inline-block; background-color: #2596be; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 600; font-size: 16px;">Konfirmasi Pembayaran</a>
            </div>
            
            <p style="font-size: 14px; color: #6c757d; margin: 0;">
                Semoga Allah menerima zakat Anda dan menjadikannya pembersih bagi harta dan jiwa Anda. Aamiin.
            </p>
        </div>
